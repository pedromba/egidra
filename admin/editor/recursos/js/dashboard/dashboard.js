/* EGIDRA Editor — Dashboard dinámico */
(function () {
    'use strict';
    ...
    // ── KPIs: mensajes, proyectos, clientes, servicios activos ───
    function cargarKpis() {
        fetch('api/dashboard/kpis.php')
            ...
            .then(function (data) {
                ...
                document.getElementById('kpi-servicios').textContent       = d.servicios_activos;
            })
