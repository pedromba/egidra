...
(function () {
    ...
    function cambiarVista(v) {
        ...
        btnNuevo.style.display    = v === 'servicios'  ? '' : 'none';
    ...
    function abrirNuevaCat() {
        ...
        fCatId.value = ''; fCatNombre.value = ''; fCatDesc.value = '';
        fCatIcono.value = ''; fCatOrden.value = '0';
        fCatActivo.checked = true;
    ...
    function guardarCat() {
        if (!fCatNombre.value.trim()) {
            Swal.fire({ title: 'Campo requerido', text: 'El nombre de la categoría es obligatorio.', icon: 'warning' });
            return;
        }
        const fd = new FormData();
    ...
    btnNuevo?.addEventListener('click', abrirNuevoSvc);
