    ...
    <main class="ci">
        <div class="d-flex align-items-center justify-content-between gap-3 mb-4 flex-wrap">
            <div class="d-flex align-items-center gap-2">
                ...
                <span id="stats-cert" style="font-size:.75rem;color:var(--muted);"></span>
            </div>
        ...
        <div class="modal-body">
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input class="f-input" type="text" id="cert-nombre" placeholder="Ej: ISO 9001:2015 — Calidad">
                </div>
                <div class="col-md-6">
                    <label class="f-label">Organismo emisor</label>
                    <input class="f-input" type="text" id="cert-organismo" placeholder="Ej: Bureau Veritas">
                </div>
                <div class="col-md-6">
                    <label class="f-label">Año de obtención</label>
                    <input class="f-input" type="number" id="cert-anio" min="1990" max="2099" placeholder="2024">
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6">
                    ...
                    <input class="f-input" type="text" id="cert-logo" placeholder="/img/certs/iso9001.svg">
                </div>
                <div class="col-md-6">
                    <label class="f-label">URL de verificación</label>
                    <input class="f-input" type="url" id="cert-url" placeholder="https://...">
                </div>
                <div class="col-md-6">
                    <label class="f-label">Fecha de vencimiento</label>
                    <input class="f-input" type="date" id="cert-vencimiento">
                </div>
                <div class="col-md-6">
                    <label class="f-label">Orden</label>
                    <input class="f-input" type="number" id="cert-orden" min="0" max="99" placeholder="0">
                </div>
                <div class="col-12 d-flex align-items-center justify-content-between">
                    <label class="f-label mb-0">Publicada</label>
                    <label class="toggle-sw"><input type="checkbox" id="cert-estado" checked><span class="toggle-slider"></span></label>
                </div>
            </div>
        </div>
