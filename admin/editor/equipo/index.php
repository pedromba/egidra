    ...
    <main class="ci">
        <div class="d-flex align-items-center justify-content-between gap-3 mb-4 flex-wrap">
            <div class="d-flex align-items-center gap-2">
                ...
                <span id="stats-equipo" style="font-size:.75rem;color:var(--muted);"></span>
            </div>
...
<div class="modal-backdrop-custom" id="modal-miembro">
    <div class="modal-box" style="max-width:520px;">
        <div class="modal-head">
            <h6 id="modal-miembro-title">Miembro del equipo</h6>
            <button class="modal-close" data-modal-close="modal-miembro"><i class="fas fa-times"></i></button>
        </div>
        <div class="modal-body">
            <input type="hidden" id="miem-id">
            <div class="row g-3">
                <div class="col-12">
                    <label class="f-label">Nombre completo <span class="text-danger">*</span></label>
                    <input class="f-input" type="text" id="miem-nombre" placeholder="Ej: Juan Carlos Eworo">
                </div>
                <div class="col-12">
                    <label class="f-label">Cargo</label>
                    <input class="f-input" type="text" id="miem-cargo" placeholder="Ej: Director de Operaciones">
                </div>
                <div class="col-12">
                    <label class="f-label">Biografía</label>
                    <textarea class="f-textarea" id="miem-bio" placeholder="Experiencia y especialización del miembro..."></textarea>
                </div>
                <div class="col-12">
                    ...
                    <div class="foto-upload-area" id="foto-area">
                        ...
                        <label class="foto-label" id="foto-label" for="miem-foto">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <span id="foto-label-txt">Haz clic o arrastra una imagen</span>
                            <small>JPG, PNG, WEBP · máx. 2 MB</small>
                        </label>
                        <input type="file" id="miem-foto" accept="image/jpeg,image/png,image/webp,image/gif" style="display:none;">
                        <input type="hidden" id="miem-foto-actual">
                    </div>
                </div>
                <div class="col-12">
                    <label class="f-label"><i class="fab fa-linkedin me-1" style="color:#0a66c2"></i>LinkedIn</label>
                    <input class="f-input" type="url" id="miem-linkedin" placeholder="https://linkedin.com/in/...">
                </div>
                <div class="col-md-4">
                    <label class="f-label">Orden</label>
                    <input class="f-input" type="number" id="miem-orden" min="0" max="99" placeholder="0">
                </div>
                <div class="col-md-8 d-flex align-items-center justify-content-end gap-3 mt-2">
                    <label class="f-label mb-0">Activo</label>
                    <label class="toggle-sw"><input type="checkbox" id="miem-activo" checked><span class="toggle-slider"></span></label>
                </div>
            </div>
        </div>
        <div class="modal-foot">
            <button class="btn-sec" data-modal-close="modal-miembro">Cancelar</button>
            <button class="btn-pri" id="btn-guardar-miem"><i class="fas fa-check me-1"></i>Guardar</button>
        </div>
    </div>
</div>
