                ...
                <div class="tbl-wrap">
                    <table class="tbl">
                        ...
                        <tbody id="tbody-usuarios">
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4"><i class="fas fa-spinner fa-spin me-2"></i>Cargando...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="modal-backdrop-custom" id="modal-usuario">
        <div class="modal-box">
            <div class="modal-head">
                <h6 id="modal-usuario-title">Nuevo Usuario</h6><button class="modal-close" data-modal-close="modal-usuario"><i class="fas fa-times"></i></button>
            </div>
            <div class="modal-body">
                ...
                <div class="mb-3"><label class="f-label">Rol</label><select class="f-select" id="usr-rol">
