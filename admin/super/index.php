...
<head>
    ...
    <title>Dashboard — EGIDRA Admin</title>
    ...
    <main class="ci">
        ...
        <div class="welcome-bar">
            <div class="welcome-text">
                <h5>Bienvenido, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Super Admin'); ?></h5>
                <p><?php echo date('l, d \d\e F \d\e Y'); ?> &mdash; Panel de control EGIDRA</p>
            </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-xl-3">
                <div class="kpi">
                    <div class="kpi-icon r"><i class="fas fa-users"></i></div>
                    <div>
                ...
                <div class="card-admin h-100">
                    ...
                    <div class="card-body-p">
                        <div class="qa-grid">
                            ...
                            <a href="usuarios/" class="qa-item">
                                <div class="qa-ico"><i class="fas fa-user-plus"></i></div>Usuarios
                            </a>
                            <a href="empresa/" class="qa-item">
                                <div class="qa-ico"><i class="fas fa-building-columns"></i></div>Empresa
                            </a>
        ...
        <!-- Actividad reciente — log-feed rellenado por dashboard.js -->
        <div class="row g-3">
            <div class="col-12">
                <div class="card-admin">
                    <div class="card-head">
                        <h6><i class="fas fa-list-check me-2" style="color:var(--primary)"></i>Actividad reciente</h6>
                        <a href="logs/" class="btn-sec" style="font-size:.72rem;padding:5px 10px;">Ver todos</a>
                    </div>
                    <div class="log-feed" id="feed-actividad">
                        <div class="log-row">
                            <span class="text-muted" style="font-size:.83rem;">Cargando actividad...</span>
                        </div>
                    </div>
                </div>
            </div>
