...
if ($id > 0) {
    ...
    $stmt->bind_param('siisis' . 'siii', $titulo, $cat_id, $cli_id, $ubicacion, $ano, $desc, $imagen, $dest, $activo, $id);
} else {
    $stmt = $conexion->prepare(
    ...
    $stmt->bind_param('siisis' . 'sii', $titulo, $cat_id, $cli_id, $ubicacion, $ano, $desc, $imagen, $dest, $activo);
}
